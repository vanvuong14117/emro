...
<head>
    ...
    <script type="text/javascript">
        ...
        function onLogin() {
            ...
            document.loginForm.locale.value = document.getElementById('lang').value;
        ...
        function onRegNewVendor() {
            ...
            UT.popupJspByPost("newVendor.do",param,null, 1200, 760, {
                "sc-window-hided": function () {
                    location.href = "spLoginEn.do";
                },
                "close": function (e) {
                    location.href = "spLoginEn.do";
                }
            }, { maximizable: true, titleText: "New Vendor Registration" });
        }
        ...
        function popupTerms(termType) {
            var me = this;
            var titleText = termType == 'SYS_TERMCND' ? 'Terms & Conditions' : 'Personal Info. Security';
            var locale = document.getElementById('lang').value;
            var tenant = document.getElementById('tenant').value;
        ...
        function popupHelpDesk() {
            var me = this;
            UT.popupJsp('resources/login/contents/en/help_desk_en.html', me, 500, 273, null, { titleText: 'Helpdesk', resizable: false });
        }
        function popupEthical() {
            var me = this;
            UT.popupJsp('resources/login/contents/en/ethical_en.html', me, 500, 280, null, { titleText: 'ESG', resizable: false });
        }
        ...
        <div class="container">
            ...
            <div class="login_wrap">
                ...
                <div class="login_tab_bar">
                    <div data-tab="tab1" class="tab active"><a>ID</a></div>
                    <div data-tab="tab2" class="tab"><a>Joint Certificate</a></div>
                </div>
                <!---- ID Login ---->
                <div id="tab1" class="tab_contents active">
                    <form name="loginForm" action="<c:url value='/spLoginProcess.do'/>" method="post">
                        <div class="form">
                            ...
                            <input id="locale" name="locale" hidden="true"/>
                        </div>
                        <div class="login_more">
                            ...
                            <div class="login_search">
                                <a href="#" onclick="popupFindIdEn()" href="">ID Search</a>
                                <span>/</span>
                                <a href="#" onclick="popupFindPwEn()" href="">Password Search</a>
                            </div>
                        </div>
                        <div class="btn_login">
                            <a onclick="onLogin()" title="ID Login" class="btn">LOGIN</a>
                        </div>
                ...
                <div id="tab2" class="tab_contents">
                    <form>
                        <div class="form">
                            ...
                            <p class="form_row">
                                <select id="certLocale" name="locale" onchange="onChangeLocale(this)">
                                    <option value="en_US">English</option>
                                    <option value="ko_KR">Korean</option>
                                    <option value="zh_CN">Chinese</option>
                                </select>
                        ...
                        <div class="btn_login">
                            <a onclick="onCertLogin()" title="Joint Certificate Login" class="btn">LOGIN</a>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="banner_wrap">
                <a href="#" onclick="onRegNewVendor()" href="" class="banner"><b>New Vendor Registration</b></a>
                <a href="https://raadmin.crosscert.com/customer/emro/index.html" target="_blank"class="banner"><b>Joint Certificate Guide</b></a>
                <a href="#" onclick="popupEthical()" href="" class="banner"><b>ESG</b></a>
            </div>
            <!-- Footer -->
            <div class="footer">
                <div class="footer_link">
                    <a href="#" onclick="popupTerms('PRSN_INFO_COLL_USG_AGT')" href="">Personal Info. Security</a>
                    <a href="#" onclick="popupTerms('SYS_TERMCND')" href="">Terms & Conditions</a>
